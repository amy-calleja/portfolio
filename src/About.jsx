    ...
    <Container className="mt-5 mb-5">
      <div id="about" className="About mt-5 mb-5">
        <Stack gap={2} className="col-md-8 mx-auto">
          ...
          <br />
          My background in graphic design and creative direction naturally helps
          me to design responsive and attractive UIs that match the brand
          identity and vision of each project.
          <Icons />
        </Stack>
      </div>
    </Container>
